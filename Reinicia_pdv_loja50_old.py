...
def Caixa1():
	if var.get() == 1:
		ret = subprocess.call("pskill -t \\\\192.168.50.1 -u pdv -p pdv pdvsal.exe", shell=True)
		if ret == 1:
			time.sleep(5)
...
def Caixa2():
	if var.get() == 1:
		ret = subprocess.call("pskill -t \\\\192.168.50.2 -u pdv -p pdv pdvsal.exe", shell=True)
		if ret == 1:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "CAIXA SEM USUÁRIO OU SEM REDE - LIGUE REMARCA")
			if resp == "ok":
...
def Caixa3():
	if var.get() == 1:
		ret = subprocess.call("pskill -t \\\\192.168.50.3 -u pdv -p pdv pdvsal.exe", shell=True)
		if ret == 1:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "CAIXA SEM USUÁRIO OU SEM REDE - LIGUE REMARCA")
			if resp == "ok":
...
def Caixa4():
	if var.get() == 1:
		ret = subprocess.call("pskill -t \\\\192.168.50.4 -u pdv -p pdv pdvsal.exe", shell=True)
		if ret == 1:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "CAIXA SEM USUÁRIO OU SEM REDE - LIGUE REMARCA")
			if resp == "ok":
...
def Caixa5():
	if var.get() == 1:
		ret = subprocess.call("pskill -t \\\\192.168.50.5 -u pdv -p pdv pdvsal.exe", shell=True)
		if ret == 1:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "CAIXA SEM USUÁRIO OU SEM REDE - LIGUE REMARCA")
			if resp == "ok":
...
def Caixa6():
	if var.get() == 1:
		ret = subprocess.call("pskill -t \\\\192.168.50.6 -u pdv -p pdv pdvsal.exe", shell=True)
		if ret == 1:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "CAIXA SEM USUÁRIO OU SEM REDE - LIGUE REMARCA")
			if resp == "ok":
...
def Caixa7():
	if var.get() == 1:
		ret = subprocess.call("pskill -t \\\\192.168.50.7 -u pdv -p pdv pdvsal.exe", shell=True)
		if ret == 1:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "CAIXA SEM USUÁRIO OU SEM REDE - LIGUE REMARCA")
			if resp == "ok":
...
def Caixa8():
	if var.get() == 1:
		ret = subprocess.call("pskill -t \\\\192.168.50.8 -u pdv -p pdv pdvsal.exe", shell=True)
		if ret == 1:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "CAIXA SEM USUÁRIO OU SEM REDE - LIGUE REMARCA")
			if resp == "ok":
...
def Caixa9():
	if var.get() == 1:
		ret = subprocess.call("pskill -t \\\\192.168.50.9 -u pdv -p pdv pdvsal.exe", shell=True)
		if ret == 1:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "CAIXA SEM USUÁRIO OU SEM REDE - LIGUE REMARCA")
			if resp == "ok":
			...
			ret = subprocess.call("psexec.exe -d -i -u pdv\PDV -p pdv \\\\192.168.50.9 ""c:\\pdv\inicia_pdv.bat", shell=True)
			if ret ==2:
				time.sleep(5)
				resp = messagebox.showerror("Erro", "ERRO - LIGAR PARA A REMARCA!")	
				if resp == "ok":
		...
		ret = subprocess.call("psexec.exe -d -i -u pdv\PDV -p pdv \\\\192.168.50.9 ""c:\\pdv\desligar.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			if resp == "ok":
...
def Caixa10():
	if var.get() == 1:
		ret = subprocess.call("pskill -t \\\\192.168.50.10 -u pdv -p pdv pdvsal.exe", shell=True)
		if ret == 1:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "CAIXA SEM USUÁRIO OU SEM REDE - LIGUE REMARCA")
			if resp == "ok":
...
def Caixa11():
	if var.get() == 1:
		ret = subprocess.call("pskill -t \\\\192.168.50.11 -u pdv -p pdv pdvsal.exe", shell=True)
		if ret == 1:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "CAIXA SEM USUÁRIO OU SEM REDE - LIGUE REMARCA")
			if resp == "ok":
...
def Caixa12():
	if var.get() == 1:
		ret = subprocess.call("pskill -t \\\\192.168.50.12 -u pdv -p pdv pdvsal.exe", shell=True)
		if ret == 1:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "CAIXA SEM USUÁRIO OU SEM REDE - LIGUE REMARCA")
			if resp == "ok":
			...
			if ret ==2:
				...
				time.sleep(5)
				resp = messagebox.showinfo("Informacao", "REINICIADO O CAIXA 52")
				if resp == "ok":
					res = "Pronto!!!"
					res_texto(res)
		else:
		...
		if ret == 53:
			...
			time.sleep(5)
			resp = messagebox.showinfo("Informacao", "CAIXA 52 ESTA SENDO REINICIADO, AGUARDE...")
			if resp == "ok":
				res = "Pronto!!!"
				res_texto(res)
		else:
...
def Caixa13():
	if var.get() == 1:
		ret = subprocess.call("pskill -t \\\\192.168.50.13 -u pdv -p pdv pdvsal.exe", shell=True)
		if ret == 1:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "CAIXA SEM USUÁRIO OU SEM REDE - LIGUE REMARCA")
			if resp == "ok":
...
def Caixa14():
	if var.get() == 1:
		ret = subprocess.call("pskill -t \\\\192.168.50.14 -u pdv -p pdv pdvsal.exe", shell=True)
		if ret == 1:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "CAIXA SEM USUÁRIO OU SEM REDE - LIGUE REMARCA")
			if resp == "ok":
...
def Caixa15():
	if var.get() == 1:
		ret = subprocess.call("pskill -t \\\\192.168.50.15 -u pdv -p pdv pdvsal.exe", shell=True)
		if ret == 1:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "CAIXA SEM USUÁRIO OU SEM REDE - LIGUE REMARCA")
			if resp == "ok":
...
def Caixa16():
	if var.get() == 1:
		ret = subprocess.call("pskill -t \\\\192.168.50.16 -u pdv -p pdv pdvsal.exe", shell=True)
		if ret == 1:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "CAIXA SEM USUÁRIO OU SEM REDE - LIGUE REMARCA")
			if resp == "ok":
...
def Caixa17():
	if var.get() == 1:
		ret = subprocess.call("pskill -t \\\\192.168.50.17 -u pdv -p pdv pdvsal.exe", shell=True)
		if ret == 1:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "CAIXA SEM USUÁRIO OU SEM REDE - LIGUE REMARCA")
			if resp == "ok":
...
def Caixa18():
	if var.get() == 1:
		ret = subprocess.call("pskill -t \\\\192.168.50.18 -u pdv -p pdv pdvsal.exe", shell=True)
		if ret == 1:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "CAIXA SEM USUÁRIO OU SEM REDE - LIGUE REMARCA")
			if resp == "ok":
...
def Caixa19():
	if var.get() == 1:
		ret = subprocess.call("pskill -t \\\\192.168.50.19 -u pdv -p pdv pdvsal.exe", shell=True)
		if ret == 1:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "CAIXA SEM USUÁRIO OU SEM REDE - LIGUE REMARCA")
			if resp == "ok":
...
def Caixa20():
	if var.get() == 1:
		ret = subprocess.call("pskill -t \\\\192.168.50.20 -u pdv -p pdv pdvsal.exe", shell=True)
		if ret == 1:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "CAIXA SEM USUÁRIO OU SEM REDE - LIGUE REMARCA")
			if resp == "ok":
...
def Caixa21():
	if var.get() == 1:
		ret = subprocess.call("pskill -t \\\\192.168.50.21 -u pdv -p pdv pdvsal.exe", shell=True)
		if ret == 1:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "CAIXA SEM USUÁRIO OU SEM REDE - LIGUE REMARCA")
			if resp == "ok":
...
def Caixa22():
	if var.get() == 1:
		ret = subprocess.call("pskill -t \\\\192.168.50.22 -u pdv -p pdv pdvsal.exe", shell=True)
		if ret == 1:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "CAIXA SEM USUÁRIO OU SEM REDE - LIGUE REMARCA")
			if resp == "ok":
...
def Caixa23():
	if var.get() == 1:
		ret = subprocess.call("pskill -t \\\\192.168.50.23 -u pdv -p pdv pdvsal.exe", shell=True)
		if ret == 1:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "CAIXA SEM USUÁRIO OU SEM REDE - LIGUE REMARCA")
			if resp == "ok":
...
def Caixa24():
	if var.get() == 1:
		ret = subprocess.call("pskill -t \\\\192.168.50.24 -u pdv -p pdv pdvsal.exe", shell=True)
		if ret == 1:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "CAIXA SEM USUÁRIO OU SEM REDE - LIGUE REMARCA")
			if resp == "ok":
...
def Caixa25():
	if var.get() == 1:
		ret = subprocess.call("pskill -t \\\\192.168.50.25 -u pdv -p pdv pdvsal.exe", shell=True)
		if ret == 1:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "CAIXA SEM USUÁRIO OU SEM REDE - LIGUE REMARCA")
			if resp == "ok":
...
def Caixa26():
	if var.get() == 1:
		ret = subprocess.call("pskill -t \\\\192.168.50.26 -u pdv -p pdv pdvsal.exe", shell=True)
		if ret == 1:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "CAIXA SEM USUÁRIO OU SEM REDE - LIGUE REMARCA")
			if resp == "ok":
...
def Caixa27():
	if var.get() == 1:
		ret = subprocess.call("pskill -t \\\\192.168.50.27 -u pdv -p pdv pdvsal.exe", shell=True)
		if ret == 1:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "CAIXA SEM USUÁRIO OU SEM REDE - LIGUE REMARCA")
			if resp == "ok":
...
btn52 = Button(bottomFrame, text="Caixa 12", bg="white", fg="black", command=Caixa12)
#btn1.pack(side=LEFT, anchor=W, expand=0)
btn52.bind('<Button-1>', Aguarde)
btn52.grid(column=1, row = 2)
