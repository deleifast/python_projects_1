...
gui.title("PDVCORAL_REMARCA - NAGUMO **(LOJA 10)**")
...
def Caixa1():
	if var.get() == 1:
		ret = subprocess.call("taskkill /s 192.168.10.1 /u PDV /p pdv /im PDVSAL.EXE", shell=True)
		if ret == 1:
			time.sleep(5)
			...
			ret = subprocess.call("psexec.exe -d -i -u pdv\PDV -p pdv \\\\192.168.10.1 ""c:\\pdv\inicia_pdv.bat", shell=True)
			if ret ==2:
				time.sleep(5)
		...
		ret = subprocess.call("psexec.exe -d -i -u pdv\PDV -p pdv \\\\192.168.10.1 ""c:\\pdv\desligar.bat", shell=True)
		if ret == 53:
			time.sleep(5)
...
def Caixa2():
	if var.get() == 1:
		ret = subprocess.call("taskkill /s 192.168.10.2 /u PDV /p pdv /im PDVSAL.EXE", shell=True)
		if ret == 1:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "CAIXA SEM USUÁRIO OU SEM REDE - LIGUE REMARCA")
			if resp == "ok":
			...
			ret = subprocess.call("psexec.exe -d -i -u pdv\PDV -p pdv \\\\192.168.10.2 ""c:\\pdv\inicia_pdv.bat", shell=True)
			if ret ==2:
				time.sleep(5)
				resp = messagebox.showerror("Erro", "ERRO - LIGAR PARA A REMARCA!")	
				if resp == "ok":
		...
		ret = subprocess.call("psexec.exe -d -i -u pdv\PDV -p pdv \\\\192.168.10.2 ""c:\\pdv\desligar.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			if resp == "ok":
...
def Caixa3():
	if var.get() == 1:
		ret = subprocess.call("taskkill /s 192.168.10.3 /u PDV /p pdv /im PDVSAL.EXE", shell=True)
		if ret == 1:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "CAIXA SEM USUÁRIO OU SEM REDE - LIGUE REMARCA")
			if resp == "ok":
			...
			ret = subprocess.call("psexec.exe -d -i -u pdv\PDV -p pdv \\\\192.168.10.3 ""c:\\pdv\inicia_pdv.bat", shell=True)
			if ret ==2:
				time.sleep(5)
				resp = messagebox.showerror("Erro", "ERRO - LIGAR PARA A REMARCA!")	
				if resp == "ok":
		...
		ret = subprocess.call("psexec.exe -d -i -u pdv\PDV -p pdv \\\\192.168.10.3 ""c:\\pdv\desligar.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			if resp == "ok":
...
def Caixa4():
	if var.get() == 1:
		ret = subprocess.call("taskkill /s 192.168.10.4 /u PDV /p pdv /im PDVSAL.EXE", shell=True)
		if ret == 1:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "CAIXA SEM USUÁRIO OU SEM REDE - LIGUE REMARCA")
			if resp == "ok":
			...
			ret = subprocess.call("psexec.exe -d -i -u pdv\PDV -p pdv \\\\192.168.10.4 ""c:\\pdv\inicia_pdv.bat", shell=True)
			if ret ==2:
				time.sleep(5)
				resp = messagebox.showerror("Erro", "ERRO - LIGAR PARA A REMARCA!")	
				if resp == "ok":
		...
		ret = subprocess.call("psexec.exe -d -i -u pdv\PDV -p pdv \\\\192.168.10.4 ""c:\\pdv\desligar.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			if resp == "ok":
...
def Caixa5():
	if var.get() == 1:
		ret = subprocess.call("taskkill /s 192.168.10.5 /u PDV /p pdv /im PDVSAL.EXE", shell=True)
		if ret == 1:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "CAIXA SEM USUÁRIO OU SEM REDE - LIGUE REMARCA")
			if resp == "ok":
			...
			ret = subprocess.call("psexec.exe -d -i -u pdv\PDV -p pdv \\\\192.168.10.5 ""c:\\pdv\inicia_pdv.bat", shell=True)
			if ret ==2:
				time.sleep(5)
				resp = messagebox.showerror("Erro", "ERRO - LIGAR PARA A REMARCA!")	
				if resp == "ok":
		...
		ret = subprocess.call("psexec.exe -d -i -u pdv\PDV -p pdv \\\\192.168.10.5 ""c:\\pdv\desligar.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			if resp == "ok":
...
def Caixa6():
	if var.get() == 1:
		ret = subprocess.call("taskkill /s 192.168.10.6 /u PDV /p pdv /im PDVSAL.EXE", shell=True)
		if ret == 1:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "CAIXA SEM USUÁRIO OU SEM REDE - LIGUE REMARCA")
			if resp == "ok":
			...
			ret = subprocess.call("psexec.exe -d -i -u pdv\PDV -p pdv \\\\192.168.10.6 ""c:\\pdv\inicia_pdv.bat", shell=True)
			if ret ==2:
				time.sleep(5)
				resp = messagebox.showerror("Erro", "ERRO - LIGAR PARA A REMARCA!")	
				if resp == "ok":
		...
		ret = subprocess.call("psexec.exe -d -i -u pdv\PDV -p pdv \\\\192.168.10.6 ""c:\\pdv\desligar.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			if resp == "ok":
...
def Caixa7():
	if var.get() == 1:
		ret = subprocess.call("taskkill /s 192.168.10.7 /u PDV /p pdv /im PDVSAL.EXE", shell=True)
		if ret == 1:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "CAIXA SEM USUÁRIO OU SEM REDE - LIGUE REMARCA")
			if resp == "ok":
			...
			ret = subprocess.call("psexec.exe -d -i -u pdv\PDV -p pdv \\\\192.168.10.7 ""c:\\pdv\inicia_pdv.bat", shell=True)
			if ret ==2:
				time.sleep(5)
				resp = messagebox.showerror("Erro", "ERRO - LIGAR PARA A REMARCA!")	
				if resp == "ok":
		...
		ret = subprocess.call("psexec.exe -d -i -u pdv\PDV -p pdv \\\\192.168.10.7 ""c:\\pdv\desligar.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			if resp == "ok":
...
def Caixa8():
	if var.get() == 1:
		ret = subprocess.call("taskkill /s 192.168.10.8 /u PDV /p pdv /im PDVSAL.EXE", shell=True)
		if ret == 1:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "CAIXA SEM USUÁRIO OU SEM REDE - LIGUE REMARCA")
			if resp == "ok":
			...
			ret = subprocess.call("psexec.exe -d -i -u pdv\PDV -p pdv \\\\192.168.10.8 ""c:\\pdv\inicia_pdv.bat", shell=True)
			if ret ==2:
				time.sleep(5)
				resp = messagebox.showerror("Erro", "ERRO - LIGAR PARA A REMARCA!")	
				if resp == "ok":
		...
		ret = subprocess.call("psexec.exe -d -i -u pdv\PDV -p pdv \\\\192.168.10.8 ""c:\\pdv\desligar.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			if resp == "ok":
...
def Caixa9():
	if var.get() == 1:
		ret = subprocess.call("taskkill /s 192.168.10.9 /u PDV /p pdv /im PDVSAL.EXE", shell=True)
		if ret == 1:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "CAIXA SEM USUÁRIO OU SEM REDE - LIGUE REMARCA")
			if resp == "ok":
			...
			ret = subprocess.call("psexec.exe -d -i -u pdv\PDV -p pdv \\\\192.168.10.9 ""c:\\pdv\inicia_pdv.bat", shell=True)
			if ret ==2:
				time.sleep(5)
				resp = messagebox.showerror("Erro", "ERRO - LIGAR PARA A REMARCA!")	
				if resp == "ok":
		...
		ret = subprocess.call("psexec.exe -d -i -u pdv\PDV -p pdv \\\\192.168.10.9 ""c:\\pdv\desligar.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			if resp == "ok":
