...
gui.title("PDVCORAL_REMARCA - NAGUMO **(LOJA 30)**")
...
def Caixa1():
	if var.get() == 1:
		ret = subprocess.call("taskkill /s 192.168.30.1 /u PDV /p pdv /im PDVSAL.EXE", shell=True)
		if ret == 1:
			time.sleep(5)
			...
			subprocess.call("taskkill /s 192.168.30.1 /u PDV /p pdv /im WerFault.exe", shell=True)
			ret = subprocess.call("psexec.exe -d -i -u pdv\PDV -p pdv \\\\192.168.30.1 ""c:\\pdv\inicia_pdv.bat", shell=True)
			if ret ==2:
				time.sleep(5)
...
def Caixa2():
	if var.get() == 1:
		ret = subprocess.call("taskkill /s 192.168.30.2 /u PDV /p pdv /im PDVSAL.EXE", shell=True)
		if ret == 1:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "CAIXA SEM USUÁRIO OU SEM REDE - LIGUE REMARCA")
			if resp == "ok":
			...
			subprocess.call("taskkill /s 192.168.30.2 /u PDV /p pdv /im WerFault.exe", shell=True)
			ret = subprocess.call("psexec.exe -d -i -u pdv\PDV -p pdv \\\\192.168.30.2 ""c:\\pdv\inicia_pdv.bat", shell=True)
			if ret ==2:
				time.sleep(5)
				resp = messagebox.showerror("Erro", "ERRO - LIGAR PARA A REMARCA!")	
				if resp == "ok":
...
def Caixa3():
	if var.get() == 1:
		ret = subprocess.call("taskkill /s 192.168.30.3 /u PDV /p pdv /im PDVSAL.EXE", shell=True)
		if ret == 1:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "CAIXA SEM USUÁRIO OU SEM REDE - LIGUE REMARCA")
			if resp == "ok":
			...
			subprocess.call("taskkill /s 192.168.30.3 /u PDV /p pdv /im WerFault.exe", shell=True)
			ret = subprocess.call("psexec.exe -d -i -u pdv\PDV -p pdv \\\\192.168.30.3 ""c:\\pdv\inicia_pdv.bat", shell=True)
			if ret ==2:
				time.sleep(5)
				resp = messagebox.showerror("Erro", "ERRO - LIGAR PARA A REMARCA!")	
				if resp == "ok":
...
def Caixa4():
	if var.get() == 1:
		ret = subprocess.call("taskkill /s 192.168.30.4 /u PDV /p pdv /im PDVSAL.EXE", shell=True)
		if ret == 1:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "CAIXA SEM USUÁRIO OU SEM REDE - LIGUE REMARCA")
			if resp == "ok":
			...
			subprocess.call("taskkill /s 192.168.30.4 /u PDV /p pdv /im WerFault.exe", shell=True)
			ret = subprocess.call("psexec.exe -d -i -u pdv\PDV -p pdv \\\\192.168.30.4 ""c:\\pdv\inicia_pdv.bat", shell=True)
			if ret ==2:
				time.sleep(5)
				resp = messagebox.showerror("Erro", "ERRO - LIGAR PARA A REMARCA!")	
				if resp == "ok":
...
def Caixa5():
	if var.get() == 1:
		ret = subprocess.call("taskkill /s 192.168.30.5 /u PDV /p pdv /im PDVSAL.EXE", shell=True)
		if ret == 1:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "CAIXA SEM USUÁRIO OU SEM REDE - LIGUE REMARCA")
			if resp == "ok":
			...
			subprocess.call("taskkill /s 192.168.30.5 /u PDV /p pdv /im WerFault.exe", shell=True)
			ret = subprocess.call("psexec.exe -d -i -u pdv\PDV -p pdv \\\\192.168.30.5 ""c:\\pdv\inicia_pdv.bat", shell=True)
			if ret ==2:
				time.sleep(5)
				resp = messagebox.showerror("Erro", "ERRO - LIGAR PARA A REMARCA!")	
				if resp == "ok":
...
def Caixa6():
	if var.get() == 1:
		ret = subprocess.call("taskkill /s 192.168.30.6 /u PDV /p pdv /im PDVSAL.EXE", shell=True)
		if ret == 1:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "CAIXA SEM USUÁRIO OU SEM REDE - LIGUE REMARCA")
			if resp == "ok":
			...
			subprocess.call("taskkill /s 192.168.30.6 /u PDV /p pdv /im WerFault.exe", shell=True)
			ret = subprocess.call("psexec.exe -d -i -u pdv\PDV -p pdv \\\\192.168.30.6 ""c:\\pdv\inicia_pdv.bat", shell=True)
			if ret ==2:
				time.sleep(5)
				resp = messagebox.showerror("Erro", "ERRO - LIGAR PARA A REMARCA!")	
				if resp == "ok":
...
def Caixa7():
	if var.get() == 1:
		ret = subprocess.call("taskkill /s 192.168.30.7 /u PDV /p pdv /im PDVSAL.EXE", shell=True)
		if ret == 1:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "CAIXA SEM USUÁRIO OU SEM REDE - LIGUE REMARCA")
			if resp == "ok":
			...
			subprocess.call("taskkill /s 192.168.30.7 /u PDV /p pdv /im WerFault.exe", shell=True)
			ret = subprocess.call("psexec.exe -d -i -u pdv\PDV -p pdv \\\\192.168.30.7 ""c:\\pdv\inicia_pdv.bat", shell=True)
			if ret ==2:
				time.sleep(5)
				resp = messagebox.showerror("Erro", "ERRO - LIGAR PARA A REMARCA!")	
				if resp == "ok":
...
def Caixa8():
	if var.get() == 1:
		ret = subprocess.call("taskkill /s 192.168.30.8 /u PDV /p pdv /im PDVSAL.EXE", shell=True)
		if ret == 1:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "CAIXA SEM USUÁRIO OU SEM REDE - LIGUE REMARCA")
			if resp == "ok":
			...
			subprocess.call("taskkill /s 192.168.30.8 /u PDV /p pdv /im WerFault.exe", shell=True)
			ret = subprocess.call("psexec.exe -d -i -u pdv\PDV -p pdv \\\\192.168.30.8 ""c:\\pdv\inicia_pdv.bat", shell=True)
			if ret ==2:
				time.sleep(5)
				resp = messagebox.showerror("Erro", "ERRO - LIGAR PARA A REMARCA!")	
				if resp == "ok":
...
def Caixa9():
	if var.get() == 1:
		ret = subprocess.call("taskkill /s 192.168.30.9 /u PDV /p pdv /im PDVSAL.EXE", shell=True)
		if ret == 1:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "CAIXA SEM USUÁRIO OU SEM REDE - LIGUE REMARCA")
			if resp == "ok":
			...
			subprocess.call("taskkill /s 192.168.30.9 /u PDV /p pdv /im WerFault.exe", shell=True)
			ret = subprocess.call("psexec.exe -d -i -u pdv\PDV -p pdv \\\\192.168.30.9 ""c:\\pdv\inicia_pdv.bat", shell=True)
			if ret ==2:
				time.sleep(5)
				resp = messagebox.showerror("Erro", "ERRO - LIGAR PARA A REMARCA!")	
				if resp == "ok":
...
def Caixa10():
	if var.get() == 1:
		ret = subprocess.call("taskkill /s 192.168.30.10 /u PDV /p pdv /im PDVSAL.EXE", shell=True)
		if ret == 1:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "CAIXA SEM USUÁRIO OU SEM REDE - LIGUE REMARCA")
			if resp == "ok":
			...
			subprocess.call("taskkill /s 192.168.30.10 /u PDV /p pdv /im WerFault.exe", shell=True)
			ret = subprocess.call("psexec.exe -d -i -u pdv\PDV -p pdv \\\\192.168.30.10 ""c:\\pdv\inicia_pdv.bat", shell=True)
			if ret ==2:
				time.sleep(5)
				resp = messagebox.showerror("Erro", "ERRO - LIGAR PARA A REMARCA!")	
				if resp == "ok":
...
def Caixa11():
	if var.get() == 1:
		ret = subprocess.call("taskkill /s 192.168.30.11 /u PDV /p pdv /im PDVSAL.EXE", shell=True)
		if ret == 1:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "CAIXA SEM USUÁRIO OU SEM REDE - LIGUE REMARCA")
			if resp == "ok":
			...
			subprocess.call("taskkill /s 192.168.30.11 /u PDV /p pdv /im WerFault.exe", shell=True)
			ret = subprocess.call("psexec.exe -d -i -u pdv\PDV -p pdv \\\\192.168.30.11 ""c:\\pdv\inicia_pdv.bat", shell=True)
			if ret ==2:
				time.sleep(5)
				resp = messagebox.showerror("Erro", "ERRO - LIGAR PARA A REMARCA!")	
				if resp == "ok":
...
def Caixa12():
	if var.get() == 1:
		ret = subprocess.call("taskkill /s 192.168.30.12 /u PDV /p pdv /im PDVSAL.EXE", shell=True)
		if ret == 1:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "CAIXA SEM USUÁRIO OU SEM REDE - LIGUE REMARCA")
			if resp == "ok":
			...
			subprocess.call("taskkill /s 192.168.30.12 /u PDV /p pdv /im WerFault.exe", shell=True)
			ret = subprocess.call("psexec.exe -d -i -u pdv\PDV -p pdv \\\\192.168.30.12 ""c:\\pdv\inicia_pdv.bat", shell=True)
			if ret ==2:
				time.sleep(5)
				resp = messagebox.showerror("Erro", "ERRO - LIGAR PARA A REMARCA!")	
				if resp == "ok":
...
def Caixa13():
	if var.get() == 1:
		ret = subprocess.call("taskkill /s 192.168.30.13 /u PDV /p pdv /im PDVSAL.EXE", shell=True)
		if ret == 1:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "CAIXA SEM USUÁRIO OU SEM REDE - LIGUE REMARCA")
			if resp == "ok":
			...
			subprocess.call("taskkill /s 192.168.30.13 /u PDV /p pdv /im WerFault.exe", shell=True)
			ret = subprocess.call("psexec.exe -d -i -u pdv\PDV -p pdv \\\\192.168.30.13 ""c:\\pdv\inicia_pdv.bat", shell=True)
			if ret ==2:
				time.sleep(5)
				resp = messagebox.showerror("Erro", "ERRO - LIGAR PARA A REMARCA!")	
				if resp == "ok":
...
def Caixa14():
	if var.get() == 1:
		ret = subprocess.call("taskkill /s 192.168.30.14 /u PDV /p pdv /im PDVSAL.EXE", shell=True)
		if ret == 1:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "CAIXA SEM USUÁRIO OU SEM REDE - LIGUE REMARCA")
			if resp == "ok":
			...
			subprocess.call("taskkill /s 192.168.30.14 /u PDV /p pdv /im WerFault.exe", shell=True)
			ret = subprocess.call("psexec.exe -d -i -u pdv\PDV -p pdv \\\\192.168.30.14 ""c:\\pdv\inicia_pdv.bat", shell=True)
			if ret ==2:
				time.sleep(5)
				resp = messagebox.showerror("Erro", "ERRO - LIGAR PARA A REMARCA!")	
				if resp == "ok":
...
def Caixa15():
	if var.get() == 1:
		ret = subprocess.call("taskkill /s 192.168.30.15 /u PDV /p pdv /im PDVSAL.EXE", shell=True)
		if ret == 1:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "CAIXA SEM USUÁRIO OU SEM REDE - LIGUE REMARCA")
			if resp == "ok":
			...
			subprocess.call("taskkill /s 192.168.30.15 /u PDV /p pdv /im WerFault.exe", shell=True)
			ret = subprocess.call("psexec.exe -d -i -u pdv\PDV -p pdv \\\\192.168.30.15 ""c:\\pdv\inicia_pdv.bat", shell=True)
			if ret ==2:
				time.sleep(5)
				resp = messagebox.showerror("Erro", "ERRO - LIGAR PARA A REMARCA!")	
				if resp == "ok":
...
def Caixa16():
	if var.get() == 1:
		ret = subprocess.call("taskkill /s 192.168.30.16 /u PDV /p pdv /im PDVSAL.EXE", shell=True)
		if ret == 1:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "CAIXA SEM USUÁRIO OU SEM REDE - LIGUE REMARCA")
			if resp == "ok":
			...
			subprocess.call("taskkill /s 192.168.30.16 /u PDV /p pdv /im WerFault.exe", shell=True)
			ret = subprocess.call("psexec.exe -d -i -u pdv\PDV -p pdv \\\\192.168.30.16 ""c:\\pdv\inicia_pdv.bat", shell=True)
			if ret ==2:
				time.sleep(5)
				resp = messagebox.showerror("Erro", "ERRO - LIGAR PARA A REMARCA!")	
				if resp == "ok":
...
def Caixa17():
	if var.get() == 1:
		ret = subprocess.call("taskkill /s 192.168.30.17 /u PDV /p pdv /im PDVSAL.EXE", shell=True)
		if ret == 1:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "CAIXA SEM USUÁRIO OU SEM REDE - LIGUE REMARCA")
			if resp == "ok":
			...
			subprocess.call("taskkill /s 192.168.30.17 /u PDV /p pdv /im WerFault.exe", shell=True)
			ret = subprocess.call("psexec.exe -d -i -u pdv\PDV -p pdv \\\\192.168.30.17 ""c:\\pdv\inicia_pdv.bat", shell=True)
			if ret ==2:
				time.sleep(5)
				resp = messagebox.showerror("Erro", "ERRO - LIGAR PARA A REMARCA!")	
				if resp == "ok":
...
def Caixa18():
	if var.get() == 1:
		ret = subprocess.call("taskkill /s 192.168.30.18 /u PDV /p pdv /im PDVSAL.EXE", shell=True)
		if ret == 1:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "CAIXA SEM USUÁRIO OU SEM REDE - LIGUE REMARCA")
			if resp == "ok":
			...
			subprocess.call("taskkill /s 192.168.30.18 /u PDV /p pdv /im WerFault.exe", shell=True)
			ret = subprocess.call("psexec.exe -d -i -u pdv\PDV -p pdv \\\\192.168.30.18 ""c:\\pdv\inicia_pdv.bat", shell=True)
			if ret ==2:
				time.sleep(5)
				resp = messagebox.showerror("Erro", "ERRO - LIGAR PARA A REMARCA!")	
				if resp == "ok":
...
def Caixa19():
	if var.get() == 1:
		ret = subprocess.call("taskkill /s 192.168.30.19 /u PDV /p pdv /im PDVSAL.EXE", shell=True)
		if ret == 1:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "CAIXA SEM USUÁRIO OU SEM REDE - LIGUE REMARCA")
			if resp == "ok":
			...
			subprocess.call("taskkill /s 192.168.30.19 /u PDV /p pdv /im WerFault.exe", shell=True)
			ret = subprocess.call("psexec.exe -d -i -u pdv\PDV -p pdv \\\\192.168.30.19 ""c:\\pdv\inicia_pdv.bat", shell=True)
			if ret ==2:
				time.sleep(5)
				resp = messagebox.showerror("Erro", "ERRO - LIGAR PARA A REMARCA!")	
				if resp == "ok":
...
def Caixa20():
	if var.get() == 1:
		ret = subprocess.call("taskkill /s 192.168.30.20 /u PDV /p pdv /im PDVSAL.EXE", shell=True)
		if ret == 1:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "CAIXA SEM USUÁRIO OU SEM REDE - LIGUE REMARCA")
			if resp == "ok":
			...
			subprocess.call("taskkill /s 192.168.30.20 /u PDV /p pdv /im WerFault.exe", shell=True)
			ret = subprocess.call("psexec.exe -d -i -u pdv\PDV -p pdv \\\\192.168.30.20 ""c:\\pdv\inicia_pdv.bat", shell=True)
			if ret ==2:
				time.sleep(5)
				resp = messagebox.showerror("Erro", "ERRO - LIGAR PARA A REMARCA!")	
				if resp == "ok":
...
def Caixa21():
	if var.get() == 1:
		ret = subprocess.call("taskkill /s 192.168.30.21 /u PDV /p pdv /im PDVSAL.EXE", shell=True)
		if ret == 1:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "CAIXA SEM USUÁRIO OU SEM REDE - LIGUE REMARCA")
			if resp == "ok":
			...
			subprocess.call("taskkill /s 192.168.30.21 /u PDV /p pdv /im WerFault.exe", shell=True)
			ret = subprocess.call("psexec.exe -d -i -u pdv\PDV -p pdv \\\\192.168.30.21 ""c:\\pdv\inicia_pdv.bat", shell=True)
			if ret ==2:
				time.sleep(5)
				resp = messagebox.showerror("Erro", "ERRO - LIGAR PARA A REMARCA!")	
				if resp == "ok":
...
def Caixa22():
	if var.get() == 1:
		ret = subprocess.call("taskkill /s 192.168.30.22 /u PDV /p pdv /im PDVSAL.EXE", shell=True)
		if ret == 1:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "CAIXA SEM USUÁRIO OU SEM REDE - LIGUE REMARCA")
			if resp == "ok":
			...
			subprocess.call("taskkill /s 192.168.30.22 /u PDV /p pdv /im WerFault.exe", shell=True)
			ret = subprocess.call("psexec.exe -d -i -u pdv\PDV -p pdv \\\\192.168.30.22 ""c:\\pdv\inicia_pdv.bat", shell=True)
			if ret ==2:
				time.sleep(5)
				resp = messagebox.showerror("Erro", "ERRO - LIGAR PARA A REMARCA!")	
				if resp == "ok":
...
def Caixa23():
	if var.get() == 1:
		ret = subprocess.call("taskkill /s 192.168.30.23 /u PDV /p pdv /im PDVSAL.EXE", shell=True)
		if ret == 1:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "CAIXA SEM USUÁRIO OU SEM REDE - LIGUE REMARCA")
			if resp == "ok":
			...
			subprocess.call("taskkill /s 192.168.30.23 /u PDV /p pdv /im WerFault.exe", shell=True)
			ret = subprocess.call("psexec.exe -d -i -u pdv\PDV -p pdv \\\\192.168.30.23 ""c:\\pdv\inicia_pdv.bat", shell=True)
			if ret ==2:
				time.sleep(5)
				resp = messagebox.showerror("Erro", "ERRO - LIGAR PARA A REMARCA!")	
				if resp == "ok":
...
def Caixa24():
	if var.get() == 1:
		ret = subprocess.call("taskkill /s 192.168.30.24 /u PDV /p pdv /im PDVSAL.EXE", shell=True)
		if ret == 1:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "CAIXA SEM USUÁRIO OU SEM REDE - LIGUE REMARCA")
			if resp == "ok":
			...
			subprocess.call("taskkill /s 192.168.30.24 /u PDV /p pdv /im WerFault.exe", shell=True)
			ret = subprocess.call("psexec.exe -d -i -u pdv\PDV -p pdv \\\\192.168.30.24 ""c:\\pdv\inicia_pdv.bat", shell=True)
			if ret ==2:
				time.sleep(5)
				resp = messagebox.showerror("Erro", "ERRO - LIGAR PARA A REMARCA!")	
				if resp == "ok":
...
def Caixa25():
	if var.get() == 1:
		ret = subprocess.call("taskkill /s 192.168.30.25 /u PDV /p pdv /im PDVSAL.EXE", shell=True)
		if ret == 1:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "CAIXA SEM USUÁRIO OU SEM REDE - LIGUE REMARCA")
			if resp == "ok":
			...
			subprocess.call("taskkill /s 192.168.30.25 /u PDV /p pdv /im WerFault.exe", shell=True)
			ret = subprocess.call("psexec.exe -d -i -u pdv\PDV -p pdv \\\\192.168.30.25 ""c:\\pdv\inicia_pdv.bat", shell=True)
			if ret ==2:
				time.sleep(5)
				resp = messagebox.showerror("Erro", "ERRO - LIGAR PARA A REMARCA!")	
				if resp == "ok":
