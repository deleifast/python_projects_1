...
gui.title("PDVCORAL_REMARCA - NAGUMO **(LOJA 51)**")
gui.geometry("600x410")
gui.resizable(0,0)
...
def Caixa1():
	if var.get() == 1:
		ret = subprocess.call("psexec.exe -d -i -u pdv -p pdv \\\\192.168.51.1 ""c:\\pdv\inicia_pdv.bat", shell=True)
		if ret == 53:
			time.sleep(5)
		...
		ret = subprocess.call("psexec.exe -d -i -u pdv -p pdv \\\\192.168.51.1 ""c:\\pdv\desligar.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			if resp == "ok":
...
def Caixa2():
	if var.get() == 1:
		ret = subprocess.call("psexec.exe -d -i -u pdv -p pdv \\\\192.168.51.2 ""c:\\pdv\inicia_pdv.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			if resp == "ok":
		...
		ret = subprocess.call("psexec.exe -d -i -u pdv -p pdv \\\\192.168.51.2 ""c:\\pdv\desligar.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			if resp == "ok":
...
def Caixa3():
	if var.get() == 1:
		ret = subprocess.call("psexec.exe -d -i -u pdv -p pdv \\\\192.168.51.3 ""c:\\pdv\inicia_pdv.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			if resp == "ok":
		...
		ret = subprocess.call("psexec.exe -d -i -u pdv -p pdv \\\\192.168.51.3 ""c:\\pdv\desligar.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			if resp == "ok":
...
def Caixa4():
	if var.get() == 1:
		ret = subprocess.call("psexec.exe -d -i -u pdv -p pdv \\\\192.168.51.4 ""c:\\pdv\inicia_pdv.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			if resp == "ok":
		...
		ret = subprocess.call("psexec.exe -d -i -u pdv -p pdv \\\\192.168.51.4 ""c:\\pdv\desligar.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			if resp == "ok":
...
def Caixa5():
	if var.get() == 1:
		ret = subprocess.call("psexec.exe -d -i -u pdv -p pdv \\\\192.168.51.5 ""c:\\pdv\inicia_pdv.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			if resp == "ok":
		...
		ret = subprocess.call("psexec.exe -d -i -u pdv -p pdv \\\\192.168.51.5 ""c:\\pdv\desligar.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			if resp == "ok":
...
def Caixa6():
	if var.get() == 1:
		ret = subprocess.call("psexec.exe -d -i -u pdv -p pdv \\\\192.168.51.6 ""c:\\pdv\inicia_pdv.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			if resp == "ok":
		...
		ret = subprocess.call("psexec.exe -d -i -u pdv -p pdv \\\\192.168.51.6 ""c:\\pdv\desligar.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			if resp == "ok":
...
def Caixa7():
	if var.get() == 1:
		ret = subprocess.call("psexec.exe -d -i -u pdv -p pdv \\\\192.168.51.7 ""c:\\pdv\inicia_pdv.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			if resp == "ok":
		...
		ret = subprocess.call("psexec.exe -d -i -u pdv -p pdv \\\\192.168.51.7 ""c:\\pdv\desligar.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			if resp == "ok":
...
def Caixa8():
	if var.get() == 1:
		ret = subprocess.call("psexec.exe -d -i -u pdv -p pdv \\\\192.168.51.8 ""c:\\pdv\inicia_pdv.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			if resp == "ok":
		...
		ret = subprocess.call("psexec.exe -d -i -u pdv -p pdv \\\\192.168.51.8 ""c:\\pdv\desligar.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			if resp == "ok":
...
def Caixa9():
	if var.get() == 1:
		ret = subprocess.call("psexec.exe -d -i -u pdv -p pdv \\\\192.168.51.9 ""c:\\pdv\inicia_pdv.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			if resp == "ok":
		...
		ret = subprocess.call("psexec.exe -d -i -u pdv -p pdv \\\\192.168.51.9 ""c:\\pdv\desligar.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			if resp == "ok":
...
def Caixa10():
	if var.get() == 1:
		ret = subprocess.call("psexec.exe -d -i -u pdv -p pdv \\\\192.168.51.10 ""c:\\pdv\inicia_pdv.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			if resp == "ok":
		...
		ret = subprocess.call("psexec.exe -d -i -u pdv -p pdv \\\\192.168.51.10 ""c:\\pdv\desligar.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			if resp == "ok":
...
def Caixa11():
	if var.get() == 1:
		ret = subprocess.call("psexec.exe -d -i -u pdv -p pdv \\\\192.168.51.11 ""c:\\pdv\inicia_pdv.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			if resp == "ok":
		...
		ret = subprocess.call("psexec.exe -d -i -u pdv -p pdv \\\\192.168.51.11 ""c:\\pdv\desligar.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			if resp == "ok":
...
def Caixa12():
	if var.get() == 1:
		ret = subprocess.call("psexec.exe -d -i -u pdv -p pdv \\\\192.168.51.12 ""c:\\pdv\inicia_pdv.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			if resp == "ok":
		...
		ret = subprocess.call("psexec.exe -d -i -u pdv -p pdv \\\\192.168.51.12 ""c:\\pdv\desligar.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			if resp == "ok":
...
def Caixa13():
	if var.get() == 1:
		ret = subprocess.call("psexec.exe -d -i -u pdv -p pdv \\\\192.168.51.13 ""c:\\pdv\inicia_pdv.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			if resp == "ok":
		...
		ret = subprocess.call("psexec.exe -d -i -u pdv -p pdv \\\\192.168.51.13 ""c:\\pdv\desligar.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			if resp == "ok":
...
def Caixa14():
	if var.get() == 1:
		ret = subprocess.call("psexec.exe -d -i -u pdv -p pdv \\\\192.168.51.14 ""c:\\pdv\inicia_pdv.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			if resp == "ok":
		...
		ret = subprocess.call("psexec.exe -d -i -u pdv -p pdv \\\\192.168.51.14 ""c:\\pdv\desligar.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			if resp == "ok":
...
def Caixa15():
	if var.get() == 1:
		ret = subprocess.call("psexec.exe -d -i -u pdv -p pdv \\\\192.168.51.15 ""c:\\pdv\inicia_pdv.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			if resp == "ok":
		...
		ret = subprocess.call("psexec.exe -d -i -u pdv -p pdv \\\\192.168.51.15 ""c:\\pdv\desligar.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			if resp == "ok":
...
def Caixa16():
	if var.get() == 1:
		ret = subprocess.call("psexec.exe -d -i -u pdv -p pdv \\\\192.168.51.16 ""c:\\pdv\inicia_pdv.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			if resp == "ok":
		...
		ret = subprocess.call("psexec.exe -d -i -u pdv -p pdv \\\\192.168.51.16 ""c:\\pdv\desligar.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			if resp == "ok":
...
def Caixa17():
	if var.get() == 1:
		ret = subprocess.call("psexec.exe -d -i -u pdv -p pdv \\\\192.168.51.17 ""c:\\pdv\inicia_pdv.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			if resp == "ok":
		...
		ret = subprocess.call("psexec.exe -d -i -u pdv -p pdv \\\\192.168.51.17 ""c:\\pdv\desligar.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			if resp == "ok":
...
def Caixa18():
	if var.get() == 1:
		ret = subprocess.call("psexec.exe -d -i -u pdv -p pdv \\\\192.168.51.18 ""c:\\pdv\inicia_pdv.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			if resp == "ok":
		...
		ret = subprocess.call("psexec.exe -d -i -u pdv -p pdv \\\\192.168.51.18 ""c:\\pdv\desligar.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			if resp == "ok":
...
def Caixa19():
	if var.get() == 1:
		ret = subprocess.call("psexec.exe -d -i -u pdv -p pdv \\\\192.168.51.19 ""c:\\pdv\inicia_pdv.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			if resp == "ok":
		...
		ret = subprocess.call("psexec.exe -d -i -u pdv -p pdv \\\\192.168.51.19 ""c:\\pdv\desligar.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			if resp == "ok":
...
def Caixa20():
	if var.get() == 1:
		ret = subprocess.call("psexec.exe -d -i -u pdv -p pdv \\\\192.168.51.20 ""c:\\pdv\inicia_pdv.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			if resp == "ok":
		...
		ret = subprocess.call("psexec.exe -d -i -u pdv -p pdv \\\\192.168.51.20 ""c:\\pdv\desligar.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			if resp == "ok":
...
def Caixa21():
	if var.get() == 1:
		ret = subprocess.call("psexec.exe -d -i -u pdv -p pdv \\\\192.168.51.21 ""c:\\pdv\inicia_pdv.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			if resp == "ok":
		...
		ret = subprocess.call("psexec.exe -d -i -u pdv -p pdv \\\\192.168.51.21 ""c:\\pdv\desligar.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			if resp == "ok":
...
def Caixa22():
	if var.get() == 1:
		ret = subprocess.call("psexec.exe -d -i -u pdv -p pdv \\\\192.168.51.22 ""c:\\pdv\inicia_pdv.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			if resp == "ok":
		...
		ret = subprocess.call("psexec.exe -d -i -u pdv -p pdv \\\\192.168.51.22 ""c:\\pdv\desligar.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			if resp == "ok":
...
def Caixa23():
	if var.get() == 1:
		ret = subprocess.call("psexec.exe -d -i -u pdv -p pdv \\\\192.168.51.23 ""c:\\pdv\inicia_pdv.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			if resp == "ok":
		...
		ret = subprocess.call("psexec.exe -d -i -u pdv -p pdv \\\\192.168.51.23 ""c:\\pdv\desligar.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			if resp == "ok":
...
def Caixa24():
	if var.get() == 1:
		ret = subprocess.call("psexec.exe -d -i -u pdv -p pdv \\\\192.168.51.24 ""c:\\pdv\inicia_pdv.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			if resp == "ok":
		...
		ret = subprocess.call("psexec.exe -d -i -u pdv -p pdv \\\\192.168.51.24 ""c:\\pdv\desligar.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			if resp == "ok":
...
def Caixa25():
	if var.get() == 1:
		ret = subprocess.call("psexec.exe -d -i -u pdv -p pdv \\\\192.168.51.25 ""c:\\pdv\inicia_pdv.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			if resp == "ok":
		...
		ret = subprocess.call("psexec.exe -d -i -u pdv -p pdv \\\\192.168.51.25 ""c:\\pdv\desligar.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			if resp == "ok":
...
def Caixa28():
	if var.get() == 1:
		ret = subprocess.call("psexec.exe -d -i -u pdv -p pdv \\\\192.168.51.28 ""c:\\pdv\inicia_pdv.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			if resp == "ok":
		...
		ret = subprocess.call("psexec.exe -d -i -u pdv -p pdv \\\\192.168.51.28 ""c:\\pdv\desligar.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			if resp == "ok":
...
def Caixa29():
	if var.get() == 1:
		ret = subprocess.call("psexec.exe -d -i -u pdv -p pdv \\\\192.168.51.29 ""c:\\pdv\inicia_pdv.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			if resp == "ok":
		...
		ret = subprocess.call("psexec.exe -d -i -u pdv -p pdv \\\\192.168.51.29 ""c:\\pdv\desligar.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			if resp == "ok":
...
def Caixa30():
	if var.get() == 1:
		ret = subprocess.call("psexec.exe -d -i -u pdv -p pdv \\\\192.168.51.30 ""c:\\pdv\inicia_pdv.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			if resp == "ok":
		...
		ret = subprocess.call("psexec.exe -d -i -u pdv -p pdv \\\\192.168.51.30 ""c:\\pdv\desligar.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			if resp == "ok":
...
def Caixa31():
	if var.get() == 1:
		ret = subprocess.call("psexec.exe -d -i -u pdv -p pdv \\\\192.168.51.31 ""c:\\pdv\inicia_pdv.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			if resp == "ok":
		...
		ret = subprocess.call("psexec.exe -d -i -u pdv -p pdv \\\\192.168.51.31 ""c:\\pdv\desligar.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			if resp == "ok":
...
btn28 = Button(bottomFrame, text="SELF  28", bg="green", fg="yellow", command=Caixa28)
#btn1.pack(side=LEFT, anchor=W, expand=0)
btn28.bind('<Button-1>', Aguarde)
btn28.grid(column=0, row = 4)

btn29 = Button(bottomFrame, text="SELF  29", bg="green", fg="yellow", command=Caixa29)
#btn1.pack(side=LEFT, anchor=W, expand=0)
btn29.bind('<Button-1>', Aguarde)
btn29.grid(column=1, row = 4)

btn30 = Button(bottomFrame, text="SELF  30", bg="green", fg="yellow", command=Caixa30)
#btn1.pack(side=LEFT, anchor=W, expand=0)
btn30.bind('<Button-1>', Aguarde)
btn30.grid(column=2, row = 4)

btn31 = Button(bottomFrame, text="SELF  31", bg="green", fg="yellow", command=Caixa31)
#btn1.pack(side=LEFT, anchor=W, expand=0)
btn31.bind('<Button-1>', Aguarde)
btn31.grid(column=3, row = 4)
