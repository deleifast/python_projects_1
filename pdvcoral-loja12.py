...
def pdv():
		...
		if os.path.isfile(PATHPDV):
			...
			dest_dir = "C:\\PDV"
			for file in glob.glob(r'X:/loja12_pdv.rar'):
				print(file)
			shutil.copy(file, dest_dir)
			logging.info("Copiado arquivo: " + file)

		PATHPDV='C://PDV/loja12_pdv.rar'
		...
		PATHPLUGIN='X://loja12_plugin.rar'
		...
		if os.path.isfile(PATHPLUGIN):
			...
			for file in glob.glob(r'X:/loja12_plugin.rar'):
				print(file)
			shutil.copy(file, dest_dir)
			logging.info("Copiado arquivo: " + file)
		...
		PATHPLUGIN='C://PDV/PLUGIN/loja12_plugin.rar'
		...
		if os.path.isfile(PATHPLUGIN):
			...
			path = 'c://pdv/plugin/loja12_plugin.rar'
...
gui = GUI_Core()
gui.root.title("REMARCA/NAGUMO - lj12 - 4.6")
gui.root.mainloop()
