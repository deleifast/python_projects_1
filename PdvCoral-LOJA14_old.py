...
#		print('Copiando arquivos para o PDV e SAT sendo iniciado, aguarde....' + '\n')	
		...
		PATHPDV='X://loja14_pdv.zip'
		PATHPLUGIN='X://loja14_plugin.zip'

		if os.path.isfile(PATHPDV):
			
			dest_dir = "C:\\PDV"
			for file in glob.glob(r'X:/loja14_pdv.zip'):
				print(file)
...
#			print("Sem arquivos(PDV) para atualizar no Servidor" + "\n")
		...
		if os.path.isfile(PATHPLUGIN):
			...
			for file in glob.glob(r'X:/loja14_plugin.zip'):
				print(file)
			shutil.copy(file, dest_dir)
...
#			print("Sem arquivos(PLUGIN) para atualizar no Servidor" + "\n")
		...
		PATHPDV='C://PDV/loja14_pdv.zip'
		PATHPLUGIN='C://PDV/PLUGIN/loja14_plugin.zip'

		if os.path.isfile(PATHPDV):

		# specifying the zip file name
			file_pdv = "c:\\pdv\loja14_pdv.zip"
...
#				print('Extraindo todos os arquivos agora...')
		...
		# specifying the zip file name
			file_plugin = "c:\\pdv\plugin\loja14_plugin.zip"
