...
#		print('Copiando arquivos para o PDV e SAT sendo iniciado, aguarde....' + '\n')	
		...
		PATHPDV='X://loja31_pdv.zip'
		PATHPLUGIN='X://loja31_plugin.zip'

		if os.path.isfile(PATHPDV):
			
			dest_dir = "C:\\PDV"
			for file in glob.glob(r'X:/loja31_pdv.zip'):
				print(file)
...
#			print("Sem arquivos(PDV) para atualizar no Servidor" + "\n")
		...
		if os.path.isfile(PATHPLUGIN):
			...
			for file in glob.glob(r'X:/loja31_plugin.zip'):
				print(file)
			shutil.copy(file, dest_dir)
...
#			print("Sem arquivos(PLUGIN) para atualizar no Servidor" + "\n")
		...
		PATHPDV='C://PDV/loja31_pdv.zip'
		PATHPLUGIN='C://PDV/PLUGIN/loja31_plugin.zip'

		if os.path.isfile(PATHPDV):

		# specifying the zip file name
			file_pdv = "c:\\pdv\loja31_pdv.zip"
...
#			print("Sem arquivos(PDV) para descompactar" + "\n")
		...
		# specifying the zip file name
			file_plugin = "c:\\pdv\plugin\loja31_plugin.zip"
...
#			print("Sem arquivos(PLUGIN) para descompactar" + "\n")
		...
		if exitcode == 0:
			print(winCMD)
				...
				time.sleep(5)
				msg.pack_forget()
				msg = Label(gui.root, text="Sem conexão com o Retag, enviando e-mail....", fg="blue", font= 'Arial 18')
				msg.pack()
	...
	#			print("PDV e IP {} : {}".format(hostName,ipAddress))
				...
				msg.pack_forget()
				msg = Label(gui.root, text='Processos inicializados sem conexão com Retag!' + '\n' + 'Remarca verificar!', bg = "yellow", fg="red", font= 'Arial 18')
				msg.pack()
