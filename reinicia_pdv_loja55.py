...
logging.basicConfig(filename = "reinicia.log", format = "%(asctime)s %(message)s", datefmt='%d-%m-%y %H:%M:%S', level = logging.INFO)
...
gui.title("PDVCORAL_REMARCA - NAGUMO **(LOJA 55)**")
gui.geometry("620x380")
gui.resizable(0,0)
...
def telamotivo():
	...
	R3.pack(anchor = NW)
	R4 = Radiobutton(frame, text="Tela travada (LENDO OU DIGITANDO ITEM)", variable = nvar, value = 2, font = 'Arial 10', command = execute)
	R4.pack(anchor = NW)
	R5 = Radiobutton(frame, text="Iniciando venda (CPF)", variable = nvar, value = 3, font = 'Arial 10', command = execute)
	R5.pack(anchor = NW)
	R6 = Radiobutton(frame, text="Finalizando venda (SUBTOTAL)", variable = nvar, value = 4, font = 'Arial 10', command = execute)
	R6.pack(anchor = NW)
	R7 = Radiobutton(frame, text="Pinpad travado ou desligado", variable = nvar, value = 5, font = 'Arial 10', command = execute)
	R7.pack(anchor = NW)
	R8 = Radiobutton(frame, text="Impressora desligada ou desconectada", variable = nvar, value = 6, font = 'Arial 10', command = execute)
	R8.pack(anchor = NW)
	R9 = Radiobutton(frame, text="Scanner desligado ou desconectado", variable = nvar, value = 7, font = 'Arial 10', command = execute)
	R9.pack(anchor = NW)
	R10 = Radiobutton(frame, text="SAT desligado ou desconectado", variable = nvar, value = 8, font = 'Arial 10', command = execute)
	R10.pack(anchor = NW)
...
def Caixa1():
	if var.get() == 1:
		ret = subprocess.call("psexec.exe -d -i -u Administrator -p pdv \\\\10.133.55.1 ""c:\\pdv\inicia_pdv.bat", shell=True)
		if ret == 53:
			time.sleep(5)
		...
		ret = subprocess.call("psexec.exe -d -i -u Administrator -p pdv \\\\10.133.55.1 ""c:\\pdv\desligar.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			logging.info("CAIXA 01 - FORA DA REDE, VERIFICAR!!")
...
def Caixa2():
	if var.get() == 1:
		ret = subprocess.call("psexec.exe -d -i -u Administrator -p pdv \\\\10.133.55.2 ""c:\\pdv\inicia_pdv.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
		...
		ret = subprocess.call("psexec.exe -d -i -u Administrator -p pdv \\\\10.133.55.2 ""c:\\pdv\desligar.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			logging.info("CAIXA 02 - FORA DA REDE, VERIFICAR!!")
...
def Caixa3():
	if var.get() == 1:
		ret = subprocess.call("psexec.exe -d -i -u Administrator -p pdv \\\\10.133.55.3 ""c:\\pdv\inicia_pdv.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
		...
		ret = subprocess.call("psexec.exe -d -i -u Administrator -p pdv \\\\10.133.55.3 ""c:\\pdv\desligar.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			logging.info("CAIXA 03 - FORA DA REDE, VERIFICAR!!")
...
def Caixa4():
	if var.get() == 1:
		ret = subprocess.call("psexec.exe -d -i -u Administrator -p pdv \\\\10.133.55.4 ""c:\\pdv\inicia_pdv.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
		...
		ret = subprocess.call("psexec.exe -d -i -u Administrator -p pdv \\\\10.133.55.4 ""c:\\pdv\desligar.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			logging.info("CAIXA 04 - FORA DA REDE, VERIFICAR!!")
...
def Caixa5():
	if var.get() == 1:
		ret = subprocess.call("psexec.exe -d -i -u Administrator -p pdv \\\\10.133.55.5 ""c:\\pdv\inicia_pdv.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
		...
		ret = subprocess.call("psexec.exe -d -i -u Administrator -p pdv \\\\10.133.55.5 ""c:\\pdv\desligar.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			logging.info("CAIXA 05 - FORA DA REDE, VERIFICAR!!")
...
def Caixa6():
	if var.get() == 1:
		ret = subprocess.call("psexec.exe -d -i -u Administrator -p pdv \\\\10.133.55.6 ""c:\\pdv\inicia_pdv.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
		...
		ret = subprocess.call("psexec.exe -d -i -u Administrator -p pdv \\\\10.133.55.6 ""c:\\pdv\desligar.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			logging.info("CAIXA 06 - FORA DA REDE, VERIFICAR!!")
...
def Caixa7():
	if var.get() == 1:
		ret = subprocess.call("psexec.exe -d -i -u Administrator -p pdv \\\\10.133.55.7 ""c:\\pdv\inicia_pdv.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
		...
		ret = subprocess.call("psexec.exe -d -i -u Administrator -p pdv \\\\10.133.55.7 ""c:\\pdv\desligar.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			logging.info("CAIXA 07 - FORA DA REDE, VERIFICAR!!")
...
def Caixa8():
	if var.get() == 1:
		ret = subprocess.call("psexec.exe -d -i -u Administrator -p pdv \\\\10.133.55.8 ""c:\\pdv\inicia_pdv.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
		...
		ret = subprocess.call("psexec.exe -d -i -u Administrator -p pdv \\\\10.133.55.8 ""c:\\pdv\desligar.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			logging.info("CAIXA 08 - FORA DA REDE, VERIFICAR!!")
...
def Caixa9():
	if var.get() == 1:
		ret = subprocess.call("psexec.exe -d -i -u Administrator -p pdv \\\\10.133.55.9 ""c:\\pdv\inicia_pdv.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
		...
		ret = subprocess.call("psexec.exe -d -i -u Administrator -p pdv \\\\10.133.55.9 ""c:\\pdv\desligar.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			logging.info("CAIXA 09 - FORA DA REDE, VERIFICAR!!")
...
def Caixa10():
	if var.get() == 1:
		ret = subprocess.call("psexec.exe -d -i -u Administrator -p pdv \\\\10.133.55.10 ""c:\\pdv\inicia_pdv.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
		...
		ret = subprocess.call("psexec.exe -d -i -u Administrator -p pdv \\\\10.133.55.10 ""c:\\pdv\desligar.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			logging.info("CAIXA 10 - FORA DA REDE, VERIFICAR!!")
...
def Caixa11():
	if var.get() == 1:
		ret = subprocess.call("psexec.exe -d -i -u Administrator -p pdv \\\\10.133.55.11 ""c:\\pdv\inicia_pdv.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
		...
		ret = subprocess.call("psexec.exe -d -i -u Administrator -p pdv \\\\10.133.55.11 ""c:\\pdv\desligar.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			logging.info("CAIXA 11 - FORA DA REDE, VERIFICAR!!")
...
def Caixa12():
	if var.get() == 1:
		ret = subprocess.call("psexec.exe -d -i -u Administrator -p pdv \\\\10.133.55.12 ""c:\\pdv\inicia_pdv.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
		...
		ret = subprocess.call("psexec.exe -d -i -u Administrator -p pdv \\\\10.133.55.12 ""c:\\pdv\desligar.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			logging.info("CAIXA 12 - FORA DA REDE, VERIFICAR!!")
...
def Caixa13():
	if var.get() == 1:
		ret = subprocess.call("psexec.exe -d -i -u Administrator -p pdv \\\\10.133.55.13 ""c:\\pdv\inicia_pdv.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
		...
		ret = subprocess.call("psexec.exe -d -i -u Administrator -p pdv \\\\10.133.55.13 ""c:\\pdv\desligar.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			logging.info("CAIXA 13 - FORA DA REDE, VERIFICAR!!")
...
def Caixa14():
	if var.get() == 1:
		ret = subprocess.call("psexec.exe -d -i -u Administrator -p pdv \\\\10.133.55.14 ""c:\\pdv\inicia_pdv.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
		...
		ret = subprocess.call("psexec.exe -d -i -u Administrator -p pdv \\\\10.133.55.14 ""c:\\pdv\desligar.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			logging.info("CAIXA 14 - FORA DA REDE, VERIFICAR!!")
...
def Caixa15():
	if var.get() == 1:
		ret = subprocess.call("psexec.exe -d -i -u Administrator -p pdv \\\\10.133.55.15 ""c:\\pdv\inicia_pdv.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
		...
		ret = subprocess.call("psexec.exe -d -i -u Administrator -p pdv \\\\10.133.55.15 ""c:\\pdv\desligar.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			logging.info("CAIXA 15 - FORA DA REDE, VERIFICAR!!")
...
def Caixa16():
	if var.get() == 1:
		ret = subprocess.call("psexec.exe -d -i -u Administrator -p pdv \\\\10.133.55.16 ""c:\\pdv\inicia_pdv.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			logging.info("CAIXA 16 - FORA DA REDE, VERIFICAR!!")
			if resp == "ok":
				res = "Verificar Rede!!           erro:" + str(ret)
				res_texto(res)
		elif ret == 1326:
		...
		ret = subprocess.call("psexec.exe -d -i -u Administrator -p pdv \\\\10.133.55.16 ""c:\\pdv\desligar.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			logging.info("CAIXA 16 - FORA DA REDE, VERIFICAR!!")
			...
			resp = messagebox.showerror("Erro", "ERRO - LIGAR PARA A REMARCA!")	
			logging.info("CAIXA 16 - ERRO - LIGAR PARA A REMARCA!")
			if resp == "ok":
				res = "LIGUE - REMARCA            erro:" + str(ret)
				res_texto(res)
	else:
...
def Caixa17():
	if var.get() == 1:
		ret = subprocess.call("psexec.exe -d -i -u Administrator -p pdv \\\\10.133.55.17 ""c:\\pdv\inicia_pdv.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
		...
		ret = subprocess.call("psexec.exe -d -i -u Administrator -p pdv \\\\10.133.55.17 ""c:\\pdv\desligar.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			logging.info("CAIXA 17 - FORA DA REDE, VERIFICAR!!")
...
def Caixa18():
	if var.get() == 1:
		ret = subprocess.call("psexec.exe -d -i -u Administrator -p pdv \\\\10.133.55.18 ""c:\\pdv\inicia_pdv.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			logging.info("CAIXA18 - FORA DA REDE, VERIFICAR!!")
			if resp == "ok":
				res = "Verificar Rede!!           erro:" + str(ret)
				res_texto(res)
		elif ret == 1326:
		...
		ret = subprocess.call("psexec.exe -d -i -u Administrator -p pdv \\\\10.133.55.18 ""c:\\pdv\desligar.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			logging.info("CAIXA18 - FORA DA REDE, VERIFICAR!!")
...
def Caixa19():
	if var.get() == 1:
		ret = subprocess.call("psexec.exe -d -i -u Administrator -p pdv \\\\10.133.55.19 ""c:\\pdv\inicia_pdv.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			logging.info("CAIXA19 - FORA DA REDE, VERIFICAR!!")
			if resp == "ok":
				res = "Verificar Rede!!           erro:" + str(ret)
				res_texto(res)
		elif ret == 1326:
		...
		ret = subprocess.call("psexec.exe -d -i -u Administrator -p pdv \\\\10.133.55.19 ""c:\\pdv\desligar.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			logging.info("CAIXA19 - FORA DA REDE, VERIFICAR!!")
...
def Caixa20():
	if var.get() == 1:
		ret = subprocess.call("psexec.exe -d -i -u Administrator -p pdv \\\\10.133.55.20 ""c:\\pdv\inicia_pdv.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			logging.info("CAIXA18 - FORA DA REDE, VERIFICAR!!")
		...
		ret = subprocess.call("psexec.exe -d -i -u Administrator -p pdv \\\\10.133.55.20 ""c:\\pdv\desligar.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			logging.info("CAIXA18 - FORA DA REDE, VERIFICAR!!")
...
def Caixa21():
	if var.get() == 1:
		ret = subprocess.call("psexec.exe -d -i -u Administrator -p pdv \\\\10.133.55.21 ""c:\\pdv\inicia_pdv.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			logging.info("CAIXA21 - FORA DA REDE, VERIFICAR!!")
			if resp == "ok":
				res = "Verificar Rede!!           erro:" + str(ret)
				res_texto(res)
		elif ret == 1326:
		...
		ret = subprocess.call("psexec.exe -d -i -u Administrator -p pdv \\\\10.133.55.21 ""c:\\pdv\desligar.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			logging.info("CAIXA21 - FORA DA REDE, VERIFICAR!!")
...
def Caixa22():
	if var.get() == 1:
		ret = subprocess.call("psexec.exe -d -i -u Administrator -p pdv \\\\10.133.55.22 ""c:\\pdv\inicia_pdv.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			logging.info("CAIXA22 - FORA DA REDE, VERIFICAR!!")
			if resp == "ok":
				res = "Verificar Rede!!           erro:" + str(ret)
				res_texto(res)
		elif ret == 1326:
		...
		ret = subprocess.call("psexec.exe -d -i -u Administrator -p pdv \\\\10.133.55.22 ""c:\\pdv\desligar.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			logging.info("CAIXA22 - FORA DA REDE, VERIFICAR!!")
...
def Caixa23():
	if var.get() == 1:
		ret = subprocess.call("psexec.exe -d -i -u Administrator -p pdv \\\\10.133.55.23 ""c:\\pdv\inicia_pdv.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			logging.info("CAIXA23 - FORA DA REDE, VERIFICAR!!")
			if resp == "ok":
				res = "Verificar Rede!!           erro:" + str(ret)
				res_texto(res)
		elif ret == 1326:
		...
		ret = subprocess.call("psexec.exe -d -i -u Administrator -p pdv \\\\10.133.55.23 ""c:\\pdv\desligar.bat", shell=True)
		if ret == 53:
			time.sleep(5)
			resp = messagebox.showerror("Erro", "FORA DA REDE, VERIFICAR!!")
			logging.info("CAIXA23 - FORA DA REDE, VERIFICAR!!")
