...
class GUI_Core(object):
    ...
    def __init__(self):
        ...
        self.msg = Label(self.root, text='REMARCA/NAGUMO - Versão 4.6S - Lj26', fg="red", font='Arial 8')
		...
		if os.path.isfile(PATHPDV):
			...
			for raiz, diretorios, arquivos in os.walk('C:/PDV'):
				for arquivo in arquivos:
					if arquivo.endswith('loja26s_pdv.rar'):
